...
class IS800_2007(object):
    ...
    # IS 800:2007 Table 2 — section classification limiting ratios (multiply by ε = √(250/fy)).
    WEB_LIMIT_PLASTIC = 84.0
    WEB_LIMIT_COMPACT = 105.0
    WEB_LIMIT_SEMI_COMPACT = 126.0
    # Outstanding element of compression flange (Table 2 row i).
    FLANGE_OUTSTAND_PLASTIC = 8.4
    FLANGE_OUTSTAND_COMPACT_WELDED = 9.4
    FLANGE_OUTSTAND_COMPACT_ROLLED = 10.5
    FLANGE_OUTSTAND_SEMI_COMPACT_WELDED = 13.6
    FLANGE_OUTSTAND_SEMI_COMPACT_ROLLED = 15.7
